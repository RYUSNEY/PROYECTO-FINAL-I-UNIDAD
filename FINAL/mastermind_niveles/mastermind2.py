...
ORANGE = (210, 110, 0)
BGCOLOUR = (118, 50, 42)
COLOURS = (RED, GREEN, BLUE, YELLOW, PINK, ORANGE)  # Actualización de los colores disponibles

# Otras configuraciones
ROWS = 5
COLS = 13  # Aumento del número de columnas
TILESIZE = 60  # Reducción del tamaño de los pines
AMOUNT_COLOUR = 6  # Actualización de la cantidad de colores disponibles
